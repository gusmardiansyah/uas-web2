            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card" style="background-color: #5555;">
                                <div class="header">
                                    <h6>jumalh Dokter</h6>
                                    <h1 style="color: #fff;padding: 10px;">
                                        <?php $sql = "SELECT SUM(jumlah_obat) AS jumlah FROM `penjualan`";
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">| 
                        &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">Apotek premateu</a>, Jl. Tgk. Abu As Singkili
                    </p>
                </div>
            </footer>
